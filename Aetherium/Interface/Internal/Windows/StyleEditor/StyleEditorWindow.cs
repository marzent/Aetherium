...
namespace Aetherium.Interface.Internal.Windows.StyleEditor;

/// <summary>
/// Window for the Aetherium style editor.
/// </summary>
public class StyleEditorWindow : Window
{
    ...
    public override void Draw()
    {
        ...
        workStyle.BuiltInColors ??= StyleModelV1.AetheriumStandard.BuiltInColors;
        ...
        if (ImGui.Button(Loc.Localize("StyleEditorAddNew", "Add new style")))
        {
            ...
            var newStyle = StyleModelV1.AetheriumStandard;
        ...
        else if (ImGui.BeginTabBar("StyleEditorTabs"))
        {
            ...
            if (ImGui.BeginTabItem(Loc.Localize("StyleEditorColors", "Colors")))
            {
                ...
                foreach (var property in typeof(AetheriumColors).GetProperties(BindingFlags.Public | BindingFlags.Instance))
                {
                    ...
                    if (colorVal == null)
                    {
                        colorVal = property.GetValue(StyleModelV1.AetheriumStandard.BuiltInColors);
