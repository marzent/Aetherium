...
/// <summary>
/// Class providing various helper methods for use in Aetherium and plugins.
/// </summary>
public static class Util
{
    ...
    /// <summary>
    /// Gets the assembly version of Aetherium.
    /// </summary>
    ...
    public static int? GetGitCommitCount()
    {
        ...
        var value = attrs.FirstOrDefault(a => a.Key == "GitCommitCount")?.Value;
        if (value == null)
            return null;
        ...
        if (type.IsPointer)
        {
            ...
            if (unboxed != null)
            {
                ...
                try
                {
                    ...
                    var ptrObj = Marshal.PtrToStructure(new nint(unboxed), eType);
                    ImGui.SameLine();
                    if (ptrObj == null)
                    {
